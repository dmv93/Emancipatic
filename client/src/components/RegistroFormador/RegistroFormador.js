            ...
            <div id="caja">
                ...
                <div className="form_rf">
                    ...
                    <div className="contenidoB">
                        ...
                        <br />
                        <br />
                        {nombre && apellidos && email && telefono && dni && codpostal && poblacion && provincia && policy ? <button id="boton_rf_enviar" onClick={() => sendDataFormador()} >ENVIAR</button> : <button id="boton_rf_enviar" onClick={() => sendDataFormador()} disabled>ENVIAR</button>}
                    </div>
